package de.lobianco.saftssh.remotedesktop.data.logging
 ...
 * [de.lobianco.saftssh.remotedesktop.RemoteDesktopPluginApplication.onCreate], before [log] does
 * anything useful.
 */
object LogFileManager {
    private const val TAG = "LogFileManager"
    private const val LOG_DIR = "logs"
    private const val LOG_FILE = "remotedesktop_plugin_debug.log"
    ...
    private fun writeSessionHeader() {
        ...
        val text = buildString {
            appendLine()
            appendLine(line)
            appendLine("LobiShell Remote Desktop Plugin Debug Log — Session Start")
